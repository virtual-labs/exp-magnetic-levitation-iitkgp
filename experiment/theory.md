...
transportation, non-contact actuators, precision engineering, non-contact structures, satellite launching, etc.</br>
...
<b>Dynamic modeling of a magnetic levitation system (MLS)</b><br/>
...
The simplest non linear model of MAGLEV relating the ball position <span class="fontCss3">x</span> and coil current <span class="fontCss3">i</span> is :<br/>
...
a current proportional to the control voltage that is generated for control purpose:<br/><br/>
...
<div align="center">
<img alt="" src="./images/img_content2_2.png" class="img-fluid"></br>
<b>Fig. 2. MAGLEV model for position control</b>
</div>
<br/>

MAGLEV is a SISO plant – single input single output (Fig. 2).
Ball Position is the model output and voltage is the control signal.<br/>
...
<!--$$\ddot{x} = g - f(x,i) , f(x,i) = k\frac{i^2}{m . x^2}$$

Equilibrium point can be calculated from:

$$g = f(x,i) at \ (i_0, x_0)$$-->

The linearization steps are the following<br/>

$$\ddot{x} = -(\frac{\delta f(i,x)}{\delta i} |_{i_0,x_0} \Delta i + \frac{\delta f(i,x)}{\delta x} |_{i_0,x_0} \Delta x ), \tag 6$$
...
the open-loop system is highly unstable; the poles are located at &plusmn;46.69.<br/><br/>

<b>The physical MAGLEV system parameters</b><br/><br/>

<span class="fontCss3">m</span> — Mass of the steel ball 0.02 kg<br/>
<i style="font-family:'Times New Roman'"><b>g</b></i> — Acceleration due to gravity 9.81 m/s<sup>2</sup><br/>
<span class="fontCss3">i<sub>0</sub></span> — Equilibrium value of current 0.8 A<br/>
<span class="fontCss3">x<sub>0</sub></span> — Equilibrium value of position 0.009 m<br/>
<span class="fontCss3">k</span><sub>1</sub> — Control voltage to coil current gain 1.05 A/V<br/>
<span class="fontCss3">k</span><sub>2</sub> — Sensor gain, offset (&eta;) 143.48 V/m, -2.8 V<br/>
Control input voltage level (<span class="fontCss3">u</span>) &plusmn; 5 V<br/>
Sensor output voltage level (<span class="fontCss3">x<sub>v</sub></span>) +1.25 V to -3.75 V<br/>
...
<!--<img alt="" src="./image/img_content4.png" style="width:300px;height:100px;"></br><br/>-->
